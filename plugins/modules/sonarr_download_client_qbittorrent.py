...
DOCUMENTATION = r'''
---
module: sonarr_download_client_qbittorrent

short_description: Manages Sonarr download client qBittorrent.

version_added: "0.6.0"

description: Manages Sonarr download client qBittorrent.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_qbittorrent:
