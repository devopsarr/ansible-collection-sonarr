...
DOCUMENTATION = r'''
---
module: sonarr_download_client_usenet_blackhole

short_description: Manages Sonarr download client Usenet Blackhole.

version_added: "0.6.0"

description: Manages Sonarr download client Usenet Blackhole.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_usenet_blackhole:
    remove_completed_downloads: false
    remove_failed_downloads: false
    enable: false
    priority: 1
    name: "UsenetBlackhole"
    nzb_folder: "/usenetblackhole"
    watch_folder: "/strm"
    tags: [1,2]
