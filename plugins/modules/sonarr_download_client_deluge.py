...
DOCUMENTATION = r'''
---
module: sonarr_download_client_deluge

short_description: Manages Sonarr download client Deluge.

version_added: "0.6.0"

description: Manages Sonarr download client Deluge.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_deluge:
