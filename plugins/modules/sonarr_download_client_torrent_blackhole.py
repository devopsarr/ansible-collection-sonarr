...
DOCUMENTATION = r'''
---
module: sonarr_download_client_torrent_blackhole

short_description: Manages Sonarr download client Torrent Blackhole.

version_added: "0.6.0"

description: Manages Sonarr download client Torrent Blackhole.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_torrent_blackhole:
    remove_completed_downloads: false
    remove_failed_downloads: false
    enable: false
    priority: 1
    name: "TorrentBlackhole"
    torrent_folder: "/torrentblackhole"
    watch_folder: "/strm"
