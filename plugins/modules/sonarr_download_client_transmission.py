...
DOCUMENTATION = r'''
---
module: sonarr_download_client_transmission

short_description: Manages Sonarr download client Transmission.

version_added: "0.6.0"

description: Manages Sonarr download client Transmission.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_transmission:
