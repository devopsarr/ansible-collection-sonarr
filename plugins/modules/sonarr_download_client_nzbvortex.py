...
DOCUMENTATION = r'''
---
module: sonarr_download_client_nzbvortex

short_description: Manages Sonarr download client NZBVortex.

version_added: "0.6.0"

description: Manages Sonarr download client NZBVortex.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_nzbvortex:
