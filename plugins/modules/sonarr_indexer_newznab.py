...
DOCUMENTATION = r'''
---
module: sonarr_indexer_newznab

short_description: Manages Sonarr indexer Newznab.
...
- name: Create a indexer
  devopsarr.sonarr.sonarr_indexer_newznab:
    name: "Example"
    ...
    base_url: "http://newznab.com/rss/"
    api_path: "/api"
    api_key: "test"
    categories: [5030, 5050]
    anime_categories: []
