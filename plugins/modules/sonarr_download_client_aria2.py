...
DOCUMENTATION = r'''
---
module: sonarr_download_client_aria2

short_description: Manages Sonarr download client Aria2.

version_added: "0.6.0"

description: Manages Sonarr download client Aria2.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_aria2:
