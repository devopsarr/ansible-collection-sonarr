...
DOCUMENTATION = r'''
---
module: sonarr_download_client_torrent_download_station

short_description: Manages Sonarr download client Download Station.

version_added: "0.6.0"

description: Manages Sonarr download client Download Station.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_torrent_download_station:
