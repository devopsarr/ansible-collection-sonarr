...
DOCUMENTATION = r'''
---
module: sonarr_download_client_hadouken

short_description: Manages Sonarr download client Hadouken.

version_added: "0.6.0"

description: Manages Sonarr download client Hadouken.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_hadouken:
