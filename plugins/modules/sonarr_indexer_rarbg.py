...
DOCUMENTATION = r'''
---
module: sonarr_indexer_rarbg

short_description: Manages Sonarr indexer Rarbg.

version_added: "0.5.0"

description: Manages Sonarr indexer Rarbg.
...
- name: Create a indexer
  devopsarr.sonarr.sonarr_indexer_rarbg:
    name: "Rarbg"
