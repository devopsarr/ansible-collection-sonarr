...
DOCUMENTATION = r'''
---
module: sonarr_download_client_nzbget

short_description: Manages Sonarr download client NZBget.

version_added: "0.6.0"

description: Manages Sonarr download client NZBget.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_nzbget:
