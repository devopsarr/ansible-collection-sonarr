...
DOCUMENTATION = r'''
---
module: sonarr_indexer_hdbits

short_description: Manages Sonarr indexer HDbits.

version_added: "0.5.0"

description: Manages Sonarr indexer HDbits.
...
- name: Create a indexer
  devopsarr.sonarr.sonarr_indexer_hdbits:
    name: "Hdbits"
