...
DOCUMENTATION = r'''
---
module: sonarr_download_client_utorrent

short_description: Manages Sonarr download client uTorrent.

version_added: "0.6.0"

description: Manages Sonarr download client uTorrent.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_utorrent:
