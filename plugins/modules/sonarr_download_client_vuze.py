...
DOCUMENTATION = r'''
---
module: sonarr_download_client_vuze

short_description: Manages Sonarr download client Vuze.

version_added: "0.6.0"

description: Manages Sonarr download client Vuze.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_vuze:
