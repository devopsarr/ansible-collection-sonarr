...
DOCUMENTATION = r'''
---
module: sonarr_download_client_rtorrent

short_description: Manages Sonarr download client Rtorrent.

version_added: "0.6.0"

description: Manages Sonarr download client Rtorrent.
...
- name: Create a download client
  devopsarr.sonarr.sonarr_download_client_rtorrent:
